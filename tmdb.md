...
## 5. Paste It Into IronBranch APP

Paste the token into the IronBranch setup screen and press **Let's go**. And That's it!

---

## Something not working?

If this guide is outdated or you're running into any issues, please [open an issue](https://github.com/alirezaghnzd/movie-tracker-native/issues/new) on GitHub.
